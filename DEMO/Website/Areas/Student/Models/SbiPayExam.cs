...
namespace Website.Areas.Student.Models
{
...

    {
        ...
        public string MID = "1000858";//live mid of Examment account
        ...
        string Country = "IN";
        string Currency = "INR";
        string EncodedKey = "WLHmLk/jyu82aBE4mP20jg==";//"JrnO/NYyZoY0/G8Pn1IMcg==";//live  mid of Examment account
        ...
        int keysize = 128;
        public SbiPayExam encriptDataExam(decimal Amount1, string Other_Details1, string Success_URL1, string Failure_URL1, string year, decimal latefee, decimal amount_without_latefee, int courseyearid)
        {
            ...
            EaxmFeesSubmit fee = new EaxmFeesSubmit();
            ...
            Other_Details = Other_Details1 + ",MainYear," + courseyearid + ",Exampaper-" + year;
            fee.mid = MID;
            fee.Other_Details = Other_Details;
            try
            {
                var obj = fee.FeessubExammentbefore(fee);
                if (obj.Status == false)
                {
                    goto loop;
                }
        ...
        public SbiPayExam encriptDataExamAirPay(decimal Amount1, string Other_Details1, string Success_URL1, string Failure_URL1, string year, decimal latefee, decimal amount_without_latefee, int courseyearid, string ssEmail, string ssPhone, string ssFName, string ssLName, string ssAddress, string ssCity, string ssState, string ssCountry, string ssPincode, string ssAmount, string ssOrderId)
        {
            ...
            {
                Amount1 = 475;
                Success_URL = "http://localhost:33166/";
                Failure_URL = "http://localhost:33166/";                  
            }

            else 
            {
                Success_URL = "https://portal.DemoUniversity.com/";
                Failure_URL = "https://portal.DemoUniversity.com/";               
            }
            ...
            AirPay_Success_url = Success_URL;
            string Amount = Amount1.ToString();
            string Order_Number = "";
            string Other_Details = Other_Details1;
            DateTime now = DateTime.Now;
            ...
            Other_Details = Other_Details1 + ",MainYear," + courseyearid + ",Exampaper-" + year + "," + Order_Number + "," + StID + "," + Order_Number;
            fee.mid = MID;
            fee.Other_Details = Other_Details;
            try
            {
                var obj = fee.FeessubExammentbeforeAirPay(fee);
                if (obj.Status == false)
                {
                    goto loop;
                }
        ...
        public SbiPayExam encriptDataExamAirPay_back(decimal Amount1, string Other_Details1, string Success_URL1, string Failure_URL1, string year, decimal latefee, decimal amount_without_latefee, int courseyearid, string ssEmail, string ssPhone, string ssFName, string ssLName, string ssAddress, string ssCity, string ssState, string ssCountry, string ssPincode, string ssAmount, string ssOrderId)
        {
        ...
        loop:
            ...
            Other_Details = Other_Details1 + ",back," + courseyearid + ",Exampaper-" + year + "," + Order_Number + "," + StID + "," + Order_Number;
            fee.mid = MID;
            fee.Other_Details = Other_Details;
            fee.GetWay = "AirPay";
            ...
            try
            {
                var obj = fee.AirPayFeessubExammentbeforebackyear(fee);
                if (obj.Status == false)
                {
                    goto loop;
                }
        ...
        public SbiPayExam encriptDataExamSafexPay(decimal Amount1, string Other_Details1, string Success_URL1, string Failure_URL1, string year, decimal latefee, decimal amount_without_latefee, int courseyearid, string ssEmail, string ssPhone, string ssFName, string ssLName, string ssAddress, string ssCity, string ssState, string ssCountry, string ssPincode, string ssAmount, string ssOrderId)
        {
            ...
            SafexPaySuccessUrl = Success_URL + Success_URL1;
            SafexPayFailUrl = Failure_URL + Failure_URL1;
            SbiPayExam sbi = new SbiPayExam();
            ...
            fee.fee_without_late_fee = amount_without_latefee;
            //Other_Details = Other_Details1 + ",Exampaper-" + year;
            CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom3", "Exam/sbipayexam2", "sbipayexam2", "Id");
            int StID = (ClsLanguage.GetCookies("NBStID") != null ? Convert.ToInt32(ClsLanguage.GetCookies("NBStID")) : 0);
            int Sission = (ClsLanguage.GetCookies("NBSission") != null ? Convert.ToInt32(ClsLanguage.GetCookies("NBSission")) : 0);
            ...
            try
            {
                var obj = fee.FeessubExammentbeforeSafexPay(fee);  /*TransactionSource save in table */
                if (obj.Status == false)
                {
                    CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom3", "Exam/sbipayexam3", "feesloop", "Id");
                    goto loop;
                }
            }
            ...
            {
                CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom3", "Exam/sbipayexam1", "exaption loop", "Id");
                goto loop;
            }
            CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom3", "Exam/sbipayexam1", "beforevariable", "Id");
            //safeXperamitter
            ...
            CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom3", "Exam/sbipayexam1", "beforevariableset sbi", "Id");
        ...
        public SbiPayExam encriptDataExamEaseBuzz(decimal Amount1, string Other_Details1, string Success_URL1, string Failure_URL1, string year, decimal latefee, decimal amount_without_latefee, int courseyearid, string ssEmail, string ssPhone, string ssFName, string ssLName, string ssAddress, string ssCity, string ssState, string ssCountry, string ssPincode, string ssAmount, string ssOrderId)
        {
            ...
            try
            {
                var obj = fee.FeessubExammentbeforeEaseBuzz(fee);
                if (obj.Status == false)
                {
                    goto loop;
                }
        ...
        public SbiPayExam encriptDataExamEaseBuzzback(decimal Amount1, string Other_Details1, string Success_URL1, string Failure_URL1, string year, decimal latefee, decimal amount_without_latefee, int courseyearid, string ssEmail, string ssPhone, string ssFName, string ssLName, string ssAddress, string ssCity, string ssState, string ssCountry, string ssPincode, string ssAmount, string ssOrderId)
        {
        ...
        loop:
            ...
            Other_Details = Other_Details1 + ",BackYear," + courseyearid + ",Exampaper-" + year + "," + Order_Number + "," + StID + "," + Order_Number;
            fee.mid = MID;
            fee.Other_Details = Other_Details;
            try
            {
        ...
        public SbiPayExam encriptDataExambackyearAirPay(decimal Amount1, string Other_Details1, string Success_URL1, string Failure_URL1, string year, decimal latefee, decimal amount_without_latefee, int courseyearid, string ssEmail, string ssPhone, string ssFName, string ssLName, string ssAddress, string ssCity, string ssState, string ssCountry, string ssPincode, string ssAmount, string ssOrderId)
        {
        ...
        loop:
            ...
            try
            {
                var obj = fee.FeessubExammentbeforebackyearNewGetway(fee);
                if (obj.Status == false)
                {
                    goto loop;
                }
        ...
        public SbiPayExam encriptDataExambackyear(decimal Amount1, string Other_Details1, string Success_URL1, string Failure_URL1, string year, decimal latefee, decimal amount_without_latefee, int courseyearid)
        {
            ...
            fee.late_fee = latefee;
            fee.fee_without_late_fee = amount_without_latefee;
            Other_Details = Other_Details1 + ",Backyear," + courseyearid + ",Exampaper-" + year;
            fee.mid = MID;
            fee.Other_Details = Other_Details;
            fee.courseyearid = courseyearid;
            try
            {
                var obj = fee.FeessubExammentbeforebackyear(fee);
                if (obj.Status == false)
                {
                    goto loop;
                }
        ...
        public SbiPayExam encriptDataExamPrac(decimal Amount1, string Other_Details1, string Success_URL1, string Failure_URL1, string year, decimal latefee, decimal amount_without_latefee, int courseyearid)
        {
            ...
            fee.fee_without_late_fee = amount_without_latefee;
            //Other_Details = Other_Details1 + ",Exampaper-" + year;
            Other_Details = Other_Details1 + ",PracMainYear," + courseyearid + ",Exampaper-" + year;
            fee.mid = MID;
            fee.Other_Details = Other_Details;
            try
            {
                var obj = fee.FeessubExammentbeforePract(fee);
                if (obj.Status == false)
                {
                    goto loop;
                }
        ...
        public string pgsucessdecrypt(int sid)
        {
            try
            {
                ...
                CommonMethod.WritetoNotePaymentgateway(encData, "", HttpContext.Current.Request.Url.AbsolutePath, " pgsucessdecrypt url hit payment gatway for Examment Fee", ClsLanguage.GetCookies("NBApplicationNo"));
                string encDatadecryptdata = AES128Bit.Decrypt(encData, EncodedKey, keysize);
                var aa = encDatadecryptdata.Split('|');
                CommonMethod.WritetoNotePaymentgateway(encData, encDatadecryptdata, HttpContext.Current.Request.Url.AbsolutePath, " pgsucessdecrypt url hit payment gatway for Examment Fee", ClsLanguage.GetCookies("NBApplicationNo"));
                ...
                if (other_detail[1] == "Backyear")
                {
                    ...
                    obj = stlogin.FeessubExambackyear(stlogin);
                }
                else if (other_detail[1] == "PracMainYear")
                {
                    stlogin.courseyearid = Convert.ToInt32(other_detail[2]);
                    obj = stlogin.FeessubExamprac(stlogin);
                }
                else
                {
                    obj = stlogin.FeessubExam(stlogin);
                }

                //if(obj.Status== true)
                //{
                //    ExammentRequest Exam = new ExammentRequest();
                //    var result = Exam.ApproveExammentRequest(aa[6]);

                //}

                if (obj.Id == 0)
                {
                    paymentgatewayemailExamment(aa[6]);
                }
                return stlogin.courseyearid.ToString();
            }
            catch (Exception ex)
            {
                CommonMethod.WritetoNotePaymentgateway(ex.Message + "      " + ex.StackTrace, "", HttpContext.Current.Request.Url.AbsolutePath, "pgsucessdecrypt() url hit error on payment PaymentGateway  for Examment Fee", ClsLanguage.GetCookies("NBApplicationNo"));
                return "error";
            }
        }
        ...
        public string AirPaypgsucessdecrypt(int sid, string banktrxid, string clienttrxid, string amount1, string feeamount, string gst, string commission, string paymode, string banktxndate, string Reason, string apitxnid, string ApplicationNo, string courseyearid, string examType, string encData, string encDatadecryptdata ,string PGstatus)
        {
            try
            {
                ...
                //    Order_Number = CommonMethod.RandomNumber(100, 999) + now1.ToString("MdHHmmyyssfff");
                //    banktrxid = Order_Number;
                //    PGstatus = "Success";
                //    Reason = "LocalDoubleverify";
                //    apitxnid = Order_Number;
                //}
                ...
                if (examType == "Backyear")
                {
                    stlogin.courseyearid = Convert.ToInt32(courseyearid);
                    obj = stlogin.AirPayFeessubExambackyear(stlogin);
                }
                else if (examType == "PracMainYear")
                {
                    stlogin.courseyearid = Convert.ToInt32(courseyearid);
                    obj = stlogin.FeessubExamprac(stlogin);
                }
                ...
                {
                    obj = stlogin.AirPayFeessubExam(stlogin);
                }

                if (obj.Id == 0)
                {
                    paymentgatewayemailExamment(ApplicationNo);
                }
                return stlogin.courseyearid.ToString();
            }
            catch (Exception ex)
        ...
        public string EaseBuzzPaypgsucessdecrypt(int sid, string banktrxid, string clienttrxid, string amount1, string feeamount, string gst, string commission, string paymode, string banktxndate, string Reason, string apitxnid, string ApplicationNo, string courseyearid, string examType, string encData, string encDatadecryptdata, string PGstatus)
        {
            try
            {
                ...
                if (examType == "Backyear")
                {
                    CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam/sbipay12", "AirPaypgsucessdecrypt", "Id");
                    //CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam/ExamFeesSubmit12", "AirPaypgsucessdecrypt", "Id");
                    stlogin.courseyearid = Convert.ToInt32(courseyearid);
                    obj = stlogin.AirPayFeessubExambackyear(stlogin);
                }
                ...
                {
                    CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam/sbipay13", "AirPaypgsucessdecrypt", "Id");
                    //CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam/ExamFeesSubmit12", "AirPaypgsucessdecrypt", "Id");
                    stlogin.courseyearid = Convert.ToInt32(courseyearid);
                    obj = stlogin.FeessubExamprac(stlogin);
                }
                ...
                {
                    CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam/sbipay14", "AirPaypgsucessdecrypt", "Id");
                    obj = stlogin.EaseBuzzFeessubExam(stlogin);
                }

                CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam//sbipay15", "obj1.objExamFrom", "Id");
                ...
                if (obj.Id == 0)
                {
                    CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam//sbipay16", "obj1.objExamFrom", "Id");
                    paymentgatewayemailExamment(ApplicationNo);
                }
                return stlogin.courseyearid.ToString();
            }
            ...
            {
                CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam//sbipay17", "obj1.objExamFrom", "Id");
                CommonMethod.WritetoNotePaymentgateway(ex.Message + "      " + ex.StackTrace, "", HttpContext.Current.Request.Url.AbsolutePath, "pgsucessdecrypt() url hit error on payment PaymentGateway  for Examment Fee", ClsLanguage.GetCookies("NBApplicationNo"));
                return "error";
            }
        }
        ...
        public string SafexPaypgsucessdecrypt(int sid, string banktrxid, string clienttrxid, string amount1, string feeamount, string gst, string commission, string paymode, string banktxndate, string Reason, string apitxnid, string ApplicationNo, string courseyearid, string examType, string encData, string encDatadecryptdata, string PGstatus)
        {
            try
            {
                ...
                if (examType == "Backyear")
                {
                    CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam/sbipay12", "AirPaypgsucessdecrypt", "Id");
                    stlogin.courseyearid = Convert.ToInt32(courseyearid);
                    obj = stlogin.SafexPayFeessubExambackyear(stlogin);
                }
                else if (examType == "PracMainYear")
                {
                    CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam/sbipay13", "AirPaypgsucessdecrypt", "Id");
                ...
                {
                    CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam/sbipay14", "AirPaypgsucessdecrypt", "Id");
                    obj = stlogin.SafexPayFeessubExam(stlogin);
                }
        ...
        public string pgfaileddecrypt(int sid)
        {
            try
            {
                ...
                var aa = encDatadecryptdata.Split('|');
                CommonMethod.WritetoNotePaymentgateway(encData, encDatadecryptdata, HttpContext.Current.Request.Url.AbsolutePath, " url hit payment PaymentGateway gatway for Examment Fee", ClsLanguage.GetCookies("NBApplicationNo"));
                EaxmFeesSubmit stlogin = new EaxmFeesSubmit();
                EaxmFeesSubmit obj = new EaxmFeesSubmit();
                stlogin.Requestdata = encData;
                stlogin.dRequestdata = encDatadecryptdata;
        ...
        public string Pushresponsedecrypt(string pushRespData)
        {
            try
            {
                ...
                stlogin.Reason = aa[7];
                stlogin.apitxnid = aa[1];
                var other_detail = aa[6].Split(',');//application no, Examment
                stlogin.ApplicationNo = other_detail[0];

                if (other_detail[1] == "Backyear")
                {
                    stlogin.courseyearid = Convert.ToInt32(other_detail[2]);
                    obj = stlogin.FeessubExamPushresponse_backyear(stlogin);
                }
                else if (other_detail[1] == "PracMainYear")
                {
                    stlogin.courseyearid = Convert.ToInt32(other_detail[2]);
                    obj = stlogin.FeessubExamPushresponseprac(stlogin);
                }
                else
                {
                    obj = stlogin.FeessubExamPushresponse(stlogin);
                }
                //obj = stlogin.FeessubExamPushresponse(stlogin);
                if (obj.Status == true)
                {
                ...
                CommonMethod.WritetoNotePaymentgateway(encData, encDatadecryptdata, HttpContext.Current.Request.Url.AbsolutePath, " Paymentgateway Pushresponse  url hit payment gatway  for Examment Fee");
                if (obj.Id == 0)
                {
                    paymentgatewayemailExamment(aa[6]);
                }
            ...
            {
                CommonMethod.WritetoNotePaymentgateway(ex.Message + "      " + ex.StackTrace, "", HttpContext.Current.Request.Url.AbsolutePath, "Paymentgateway Pushresponse url hit error on payment PaymentGateway for Examment Fee");
                return "error";
            }
        }
        public void paymentgatewayemailExamment(string applicationno)
        {
            CommonMethod.TraceLogWritetoNotepad("obj1.objExamFrom4", "Exam/AirpayGetResponse21", "obj1.objExamFrom", "Id");
            return;
            ExamForm ob = new ExamForm();
            //var obj1 = ob.GetAppLicationDataForExammentFee();
            // Email.SendEmailForSt_ExamPaymentgateway(obj1.objExamFrom.Email, obj1.objPrintRecipt.status, obj1.objExamFrom.StudentName, obj1.objPrintRecipt.trxdate, obj1.objPrintRecipt.banktrxid, obj1.objPrintRecipt.TransactionId, obj1.objPrintRecipt.ApplicationNo, obj1.objfeesubmit.Fees, obj1.objPrintRecipt.PaymentType, obj1.objExamFrom.MobileNo, obj1.objExamFrom.RegistrationNo);
        }
        public string doubleverificationregistration(string data)
        {
            try
            {
                ...
                {
                    stlogin.courseyearid = Convert.ToInt32(other_detail[2]);
                    obj = stlogin.FeessubStudentPushresponseDoubleverificationExam_backlog(stlogin);
                }
                else if (other_detail[1] == "PracMainYear")
                {
                    stlogin.courseyearid = Convert.ToInt32(other_detail[2]);
                    obj = stlogin.FeessubStudentPushresponseDoubleverificationExamprac(stlogin);
                }
                else
                {
                    obj = stlogin.FeessubStudentPushresponseDoubleverificationExam(stlogin);
                }
        ...
        public string doubleverificationEnrollment_EaseBuzz(string data)
        {
            try
            {
    ...
    public class EasebuzzresponseMsg
    {
    ...
    public class FraudDetailsSafex
    {
    }

    public class OtherDetailsSafex
    {

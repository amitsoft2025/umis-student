...
namespace Website.Areas.StudentBPharma.Controllers
{
    ...
    public class ResultBPharmaController : Controller
    {
        // GET: StudentBPharma/ResultBPharma
        public ActionResult Index()
        {
            ...
            model.courseyearlist = BPharmaYears(coursecategoryid);
        ...
        //    model.courseyearlist = BPharmaYears(coursecategoryid);
        //    List<Result> studentList = new List<Result>();
        //    model.StudentListNew = model.Studentportal_GetTabulationRegisterBPharma(0, "MainExamCustomSearch", 0, 13, Convert.ToInt32(coursecategoryid), collegeid, model.CourseYearID, 0, rollno, "", model.isback, 0);
        //    obj = obj.GetBPharmaSubject(model.CourseYearID);
        ...
        //                obj123 = model.GetBPharmaSubject_single(Convert.ToInt32(model.CourseYearID), model.StudentListNew.FirstOrDefault().ElectiveSubject1_id);
        ...
        //            {
        //                Result obj123 = new Result();
        //                obj123 = model.GetBPharmaSubject_single(Convert.ToInt32(model.CourseYearID), 282);
        ...
        //            {
        //                Result obj123 = new Result();
        //                obj123 = model.GetBPharmaSubject_single(Convert.ToInt32(model.CourseYearID), 283);
        ...
        //            {
        //                Result obj123 = new Result();
        //                obj123 = model.GetBPharmaSubject_single(Convert.ToInt32(model.CourseYearID), 284);
        ...
        //            {
        //                Result obj123 = new Result();
        //                obj123 = model.GetBPharmaSubject_single(Convert.ToInt32(model.CourseYearID), model.StudentListNew.FirstOrDefault().ElectiveSubject2_id);
        ...
        //            {
        //                Result obj123 = new Result();
        //                obj123 = model.GetBPharmaSubject_single(Convert.ToInt32(model.CourseYearID), 286);
        ...
        //            {
        //                Result obj123 = new Result();
        //                obj123 = model.GetBPharmaSubject_single(Convert.ToInt32(model.CourseYearID), 287);
        ...
        public List<courseyear> BPharmaYears(int coursecategoryid)
        {

...
function resendOTP() {
    ...
    if (document.getElementById("ishandicappedYes").checked) {
        var disabilityType = $("#disabilityType").val();
        var disabilityPercent = $("#disabilityPercent").val();

        if (disabilityType == '') {
            showAlert("Please Select Type of Disability !!");
            $("#disabilityType").focus();
            return;
        }

        if (disabilityPercent == '' || parseInt(disabilityPercent) < 0 || parseInt(disabilityPercent) > 100) {
            showAlert("Please Enter Valid Disability Percentage (0 - 100) !!");
            $("#disabilityPercent").focus();
            return;
        }
    }
...
$("#firstnameHindi").blur(function (event) {
    debugger;
    var res = $(this).val();
    $.ajax({
...
function onsave() {
    ...
    if ($("#mobilenoverified").val() == "") {
        showAlert('Please Enter Mobile Number !!');
        $("#mobilenoverified").focus();
        return false;
    }
    else
    {
    ...
    if ($("#aadharno").val() == "") {
        showAlert('Please Select Aadhar No. !!');
        $("#aadharno").focus();
        return false;
    }
    ...
    if (window.FormData !== undefined)
    {
        ...
        fileData.append('mobileno', $("#mobilenoverified").val());
        ...
        fileData.append('disabilityType', $("#disabilityType").val());
        fileData.append('disabilityPercent', $("#disabilityPercent").val());
        ...
        fileData.append('aadharno', $("#aadharno").val());

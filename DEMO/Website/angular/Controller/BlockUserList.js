...
app.controller('guestuserlistCtrl', function ($scope, $http, cfpLoadingBar) {
    ...
    cfpLoadingBar.start();
        ...
        $http.get(ServiceUrl + "admin/BlockUserListpaging?pageIndex=" + $scope.pageIndex + "&pageSize=" + $scope.pageSizeSelected + "&UserId=" + UserId + "&playerID=" + playerID + "&Emailid=" + Emailid + "&Name=" + Name + "").then(
                       function (response) {

...
app.controller('InvaccreportCtrl', function ($scope, $http, cfpLoadingBar) {
    ...
    $scope.GetHandsIds = function () {
        ...
        var plantypeSearching = $scope.formSearchtype === undefined ? '' : $scope.formSearchtype;                                                                 /*      "&plantypeid=" + plantypeSearching +*/
        console.log(plantypeSearching);
        $http.get(Url + "api/ddpendinginvaccountreport?pageIndex=" + $scope.pageIndex + "&pageSize=" + $scope.pageSizeSelected + "&search=" + Searching + "&searchC=" + SearchingC + "&plantypeid=" + plantypeSearching +  "&date=" + Date + "&dateTo=" + DateTo + "").then(
            function (response) {
            ...
            $scope.cList = response.data.investmnetclosedetailsdataList;
                ...
                $scope.exportData = function () {
                    ...
                    //    debugger;
                    saveAs(bb, "PendingDDRenewalReport.xls");
                };
        ...
        //$http.get(Url + "api/PlanName_BindDD").then(
        //    function (response) {

        //        $scope.planlistType = response.data;
        //    },

        //    function (err) {
        //        var error = err;InvAccCloseDDpending
        //    });

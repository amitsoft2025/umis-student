   ...
   // debugger;
    ...
    $scope.GetHandsIds = function () {
       ...
       // debugger;
        ...
        //va//r sSearchplantype = $scope.Searchplantype === undefined ? '' : $scope.Searchplantype;
        //var plantypeSearching = $scope.Searchtype === undefined ? '' : $scope.Searchtype;
        //var plantypeSearching = $scope.Searchtype === undefined ? '' : $scope.Searchtype;
        $http.get(Url + "api/invaccountreport?pageIndex=" + $scope.pageIndex + "&pageSize=" + $scope.pageSizeSelected + "&search=" + Searching + "&customerid=" + scustomerid + "&name=" + sname + "&fromdate=" + sfromdate + "&todate=" + stodate + "&plantypeid=" + plantypeSearching + "&planid=" + sSearchplanname + "").then(
        function (response) {

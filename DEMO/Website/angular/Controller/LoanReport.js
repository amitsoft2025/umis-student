...
app.controller('InvaccreportCtrl', function ($scope, $http, cfpLoadingBar) {
   // debugger;
    ...
    $scope.loandreportetails = function () {
        cfpLoadingBar.start();
       // debugger;
        ...
        $http.get(Url + "api/Loanreport?pageIndex=" + $scope.pageIndex + "&pageSize=" + $scope.pageSizeSelected + "&search=" + Searching + "&customerid=" + scustomerid + "&name=" + sname + "&fromdate=" + sfromdate + "&todate=" + stodate + "&loantypeid=" + LoanSearching + "&loanid=" + loanSubSearching + "&app=" + sapp + "&branch=" + branch +"").then(
            function (response) {
                //debugger;

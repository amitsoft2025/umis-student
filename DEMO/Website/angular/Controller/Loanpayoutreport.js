...
app.controller('LoanSummaryCtrl', function ($scope, $http, cfpLoadingBar) {
    ...
    $scope.loandSummaryReport = function () {
        ...
        $http.get(Url + "api/loanpayoutreport?pageIndex=" + $scope.pageIndex + "&pageSize=" + $scope.pageSizeSelected + "&Representativecode=" + Representativecode1 + "&fromdate=" + sfromdate + "&toddate=" + stodate + "").then(
            function (response) {
                //debugger;
                ...
                $scope.exportData = function () {
                    ...
                    //    debugger;
                    saveAs(bb, "LoanPayoutReport.xls");
                };

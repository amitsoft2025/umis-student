...
app.controller('SavaccreportCtrl', function ($scope, $http, cfpLoadingBar) {
    ...
    $scope.GetHandsIds = function () {
        ...
        $http.get(Url + "api/Savingaccountreportclose?pageIndex=" + $scope.pageIndex + "&pageSize=" + $scope.pageSizeSelected + "&search=" + Searching + "&fromdate=" + sfromdate + "&todate=" + stodate + "&customerid=" + scustomerid + "&name=" + sname + "").then(
            function (response) {
                debugger;
                ...
                $scope.exportData = function () {
                    ...
                    //    debugger;
                    saveAs(bb, "AccountClosereport.xls");
                };

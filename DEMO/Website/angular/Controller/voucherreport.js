...
app.controller('InvaccreportCtrl', function ($scope, $http, cfpLoadingBar) {
   // debugger;
    ...
    $scope.GetHandsIds = function () {
        ...
        $http.get(Url + "api/voucherreport?PageIndex=" + $scope.pageIndex + "&PageSize=" + $scope.pageSizeSelected + "&branchid=" + sSearchplanname + "&fromdate=" + sfromdate + "&todate=" + stodate + "&voucher="+""+"").then(
        function (response) {

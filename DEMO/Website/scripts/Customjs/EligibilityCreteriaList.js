...
var app1 = angular.module('eligibilitylistApp', ['chieffancypants.loadingBar', /*'ngAnimate',*/ 'ui.bootstrap']);
app1.config(function (cfpLoadingBarProvider) {
    cfpLoadingBarProvider.includeSpinner = true;
    cfpLoadingBarProvider.latencyThreshold = 500;
});
app1.controller('eligibilitylistCtrl', function ($scope, $http, cfpLoadingBar) {
    ...
    $scope.EligibilitydetailList = function () {
        cfpLoadingBar.start();
        debugger;
        $http.get(Url + "api/eligibilityList?pageIndex=" + $scope.pageIndex + "&pageSize=" + $scope.pageSizeSelected + "").then(
            function (response) {

...
function resetapplication() {
    ...
    $("#PassingYear").val("");
    $("#file").val("");
    $("#RollNo").val(""); $("#paperMarksObtain ").val("");
    $("#paperTotalMarks ").val("");
    $("#append-big-btn").val("");
}
function percheck1() {
    ...
    if (parseInt($("#paperMarksObtain").val()) > parseInt($("#paperTotalMarks").val())) {
        $("#Percentage").val("");
        $("#paperMarksObtain").val("");
        showAlert('Paper Marks Obtain should be less Paper Total Marks !!');
        // $("#btn").attr("style", "display: none;");
        return;
    }
...
function submitapplication() {
    ...
    fileData.append('TotalMarks', "");
    fileData.append('MarksObtain', "");
    fileData.append('SubID', "");
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.Status) {
                ...
                hideloader();
                showAlert(result.Msg);
                // location.replace('/StudentV/Homev/StudentQualification');
            }
            //location.replace('/StudentV/Homev/PreviousyearQualification');
